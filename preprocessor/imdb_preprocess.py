...
#dataset_path = '/home/moo/Documents/uni/GuidedResearch/tflearn/examples/nlp/aclImdb/'
#dataset_path = '/home/moo/Documents/uni/GuidedResearch/word2vec-sentiments/e'
import numpy
...
tokenizer_cmd = [absolute_tokenizer_path, '-l', 'en', '-q', '-']
